...
import 'package:bismillah_bisa/pages/absen/camera_page.dart';
...
class _AbsenPageState extends State<AbsenPage> {
  ...
  final CollectionReference dataCollection =
      FirebaseFirestore.instance.collection('aplikasi-absensi-2f126');
                                ...
                                ScaffoldMessenger.of(context)
                                  ...
                                  content: Row(
                                    children: [
                                      ...
                                      SizedBox(width: 10),
                                      Text(
                                          "Oops, the photo and input columns cannot be empty!",
