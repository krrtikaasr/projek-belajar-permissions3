...
import 'package:bismillah_bisa/utils/facedetection/google_ml_kit.dart';
        ...
        children: [
          SizedBox(
            ...
            child: controller == null
                ? const Center(
                    child: Text("Oops, camera problem!",
                        style: TextStyle(
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  const Text(
                    "Make sure that you are in a bright room, so that your face can be seen clearly .",
                    style: TextStyle(
                        fontSize: 24,
                        color: Colors.black,
                                    ...
                                    ScaffoldMessenger.of(context)
                                      ...
                                      content: Row(
                                        children: [
                                          ...
                                          SizedBox(width: 10),
                                          Text(
                                            "Turn on location permission first.",
                                            style:
